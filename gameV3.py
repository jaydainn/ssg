...
# @name: gameV3.py => réalisé après la présentation orale
# ******************************************************
...
class Person:
    ...
    # Stratégie 1 du policier : immobile, position aléatoire
    def strategy1(self): 
        return

    # Stratégie 2 du policier : déplacement aléatoire, position aléatoire
    def strategy2(self):
        self.random_deplacement()

    # Stratégie 3 du policier : balayage
    def strategy3(self):
